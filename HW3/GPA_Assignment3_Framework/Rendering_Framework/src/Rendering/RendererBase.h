...
namespace INANOA {
	namespace OPENGL {
		...
		public:
			...
			void useGroundShaderProgram();
			void useGrassShaderProgram();
			void useSlimeShaderProgram();
			void useResetComputeShaderProgram();
			void useCullingComputeShaderProgram();
		...
		private:
			...
			ShaderProgram* groundShaderProgram = nullptr;
			ShaderProgram* grassShaderProgram = nullptr;
			ShaderProgram* slimeShaderProgram = nullptr;
			ShaderProgram* resetComputeShaderProgram = nullptr;
			ShaderProgram* cullingComputeShaderProgram = nullptr;
